...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <a href ="{{ $anggota->id }}/edit" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editSekaaGong">Edit</a>

        <form action="{{ route('hapusSekaaGong', $anggota->id) }}" method="post" class="d-inline">
            @csrf
     ...
     <!-- Edit Sekaa Gong -->
    <!-- Modal -->
    <div class="modal fade" id="editSekaaGong" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editSekaaGongLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editSekaaGongLabel">Form Edit Data</h5>
