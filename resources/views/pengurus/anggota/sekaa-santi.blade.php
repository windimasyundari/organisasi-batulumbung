...
@section('title', 'Anggota Sekaa Santi')
...
<div class="page-wrapper">
    ...
    <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Daftar Anggota Sekaa Santi</h4>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                <form class="form" method="get" action="{{ route ('cariSekaaSanti') }}">
                    <div class="col-md-6 ms-auto">
                        <input type="text" name="cariSekaaSanti" class="form-control w-75 d-inline" value="{{ request('cariSekaaSanti')}}" id="cariSekaaSanti" placeholder="Cari Nama Anggota ...">
                ...
                <div class="modal-dialog">
                    ...
                    <form method="post" action="{{ route ('tambahSekaaSanti') }}" style="width:100%">
                        @csrf
                        ...
                        <table class="table table-striped">
                            ...
                            @forelse($anggota as $anggotas)
                                <tr>
                                    ...
                                    <td><a href="\anggota\sekaa-santi\{{ $anggotas->id }}" class="btn btn-primary"><i class="bi bi-eye-fill m-r-5"></i>Detail</a></td>
                                </tr>
                                @empty
