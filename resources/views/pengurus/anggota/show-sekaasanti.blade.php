...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <a href ="{{ $anggota->id }}/edit" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editSekaaSanti">Edit</a>
    ...
    <!-- Edit Sekaa Santi -->
    <!-- Modal -->
    <div class="modal fade" id="editSekaaSanti" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editSekaaSantiLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editSekaaSantiLabel">Form Edit Data</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                <form method="post" action="/anggota/sekaa-santi/{{ $anggota->id }}" style="width:100%">
                @method('patch')
                @csrf
